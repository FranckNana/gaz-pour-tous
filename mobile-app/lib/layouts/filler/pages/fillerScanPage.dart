...
class FillerScanPage extends StatefulWidget {
  FillerScanPage({super.key, required this.targetStatus});

  BottleStatus targetStatus;

  @override
  State<FillerScanPage> createState() => _FillerScanPageState();
}

class _FillerScanPageState extends State<FillerScanPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          Utils.getProfileChip("Emplisseur"),
          IconButton(
              onPressed: () => Get.back(),
